    ...
    return Row(
      children: [
        Expanded(
          child: ClipRRect(
            child: Image.network(
              'https://ucarecdn.com/fe7cee05-e2d6-4fa4-9f50-f152da9bab79/Tshirts_para_Homem__Massimo_Dutti__PTremovebgpreview.png',
              fit: BoxFit.cover,
              height: 500,
    ...
    return Stack(
      ...
      children: [
        Image.network(
          'https://ucarecdn.com/fe7cee05-e2d6-4fa4-9f50-f152da9bab79/Tshirts_para_Homem__Massimo_Dutti__PTremovebgpreview.png',
          fit: BoxFit.cover,
          errorBuilder: (_, __, ___) => Container(color: AppColors.heroBg),
        ),
        Container(
