...
class _ProductDetailScreenState extends State<ProductDetailScreen> {
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('Customer Reviews', style: AppTextStyles.subtitle),
                    const SizedBox(height: AppDimensions.md),
                    _reviewTile(
                      'Rahul M.',
                      5,
                      'Amazing quality! The fabric is super soft and the fit is perfect. Highly recommend!',
                      '2 days ago',
                    ),
                    const Divider(),
                    _reviewTile(
                      'Sneha K.',
                      4,
                      'Great product for the price. Color is slightly different from the picture but overall good.',
                      '1 week ago',
                    ),
                    const Divider(),
                    _reviewTile(
  ...
  Widget _reviewTile(String name, int rating, String comment, String time) {
    return Padding(
